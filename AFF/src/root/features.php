    ...
    <div class="flex-container-full">
        ...
        <div class="flex-container-full theme-light-hc vl-8 o-auto my-large px-large">
            ...
            <div class="section-object d-flex-column py-medium">
                ...
                <a class="nav-item w-auto mb-small" href="<?php core_link('app.tile/content/message'); ?>">
                ...
                <a class="nav-item w-auto mb-small" href="<?php core_link('app.tile/content/badges'); ?>">
                    <div class="badge-container py-small t-32">
                ...
                <a class="nav-item w-auto mb-small" href="<?php core_link('app.tile/content/tile'); ?>">
                    <div class="badge-container py-small t-32">
            ...
            <div class="section-object d-flex-column py-medium">
                ...
                <a class="nav-item w-auto mb-small"  href="<?php core_link('app.tile/content/buttons'); ?>">
                    <div class="badge-container py-small t-32">
                ...
                <a class="nav-item w-auto mb-small" href="<?php core_link('app.tile/content/forms'); ?>">
                    <div class="badge-container py-small t-32">
                        <div class="px-medium">HTML</div>
                ...
                <a class="nav-item w-auto mb-small" href="<?php core_link('app.tile/content/animations'); ?>">
                    <div class="badge-container py-small t-32">
            ...
            <div class="section-object d-flex-column py-medium">
                ...
                <a class="nav-item w-auto mb-small" href="<?php core_link('app.tile/content/flex'); ?>">
                    <div class="badge-container py-small t-32">
